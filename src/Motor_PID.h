...
class MotorPID {
    public:
        ...
        bool init(int enc_A_pin, int enc_B_pin, int pwm_pin_1, int pwm_pin_2, int enable_pin, int counts_per_rev, ledc_channel_t ledc_channel_1, ledc_channel_t ledc_channel_2, float Kp, float Ki, float Kd, int timestep_ms);
        void IRAM_ATTR update(); // TODO: Position
    ...
    private:
        ...
        volatile float _last_raw_count = 0.0f;
        volatile float _raw_count = 0.0f;
        ...
        static bool _ledc_timer_initialized = false;
