...
#define MAX_LIFT_POS 800.0f // Maximum lift position in degrees
    ...
    switch (current_state) {
        ...
        case State::NORMAL:
            ...
            switch (rideState) {
              ...
              case SPIN_UP:
                GOAL_POS += RAMP_INCREMENT;
                if (GOAL_POS > MAX_LIFT_POS) GOAL_POS = MAX_LIFT_POS;
              ...
              case SPIN_DOWN:
                GOAL_POS -= RAMP_INCREMENT;
                if (GOAL_POS < 0.0f) GOAL_POS = 0.0f;
